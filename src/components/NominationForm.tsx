...
const academicAwards = [
  "Life Time Achievement Award (above 55 Years of Age)",
  "Hon. Fellowship (FAFSRI) (Below 40 Years of Age)",
  "Eminent Scientist award",
  "Senior Scientist Award (Above 45 years of age)",
  "Scientist Associate Award Research",
  "Young Scientist Award in Agriculture Science",
  "Young Scientist Award in Chemical Science",
  "Young Scientist Award in Animal Husbandry",
  "Young Scientist Award in Animal Science",
  "Young Scientist Award in Fisheries Sciences",
  "Young Scientist Award in Plant Science",
  "Young Scientist Award in Agriculture Outstanding Achievement Award",
  "Young Scientist Award in Social Sciences",
  "Innovative Biologist Award for Wild Life/ Biodiversity Conservation",
  "Young Scientist Award for Humanistic Studies",
  "Best Academician Award (Humanities/ Commerce and Managements/ Interdisciplinary Studies)",
  "Excellence in Extension Scientist Award",
  "Outstanding Extension Professional/Agriculture Scientist/ Social Services Award",
  "Excellence in Teaching Award (Humanities/ Commerce and Managements/ Interdisciplinary Studies.)",
  ...
  "Technological Innovations Award",
  "Young Woman Scientist Award",
  "Young Botanist/Zoologist/Scientist Award (below 30 years of age; mainly for research scholar)",
  "Excellence in Research Award for Humanistic Studies",
  "Young Professional Award (Humanities/ Commerce and Managements/ Interdisciplinary Studies)",
...
const startupAwards = [
  ...
  "eRetail Start up of the Year",
  "Best HR Tech Start up of the Year",
  "B2B Start up of the Year",
  "Tech Startup of the Year",
  "On-Demand Delivery Startup of the year",
  "Fashion Startup of the year",
  "Social Commerce Startup of the Year",
  "Agritech Startup of the Year",
  "Fintech Startup of the Year",
  "Health Tech Startup of the Year",
  "Best Drone Tech Start Up of the Year",
  "Cloud Startup of the Year",
  "Networking Startup of the Year",
  "InsureTech Startup of the Year",
  "Proptech Startup of the Year",
  "Media/Entertainment Startup of the Year",
  "SpaceTech Startup of the Year",
  ...
  "Best NFT Platform of the Year",
  "Metaverse Startup of the Year",
  ...
  "Founder Of The Year",
  "Creative Entrepreneur Of The Year - Start-up",
  "Best Social Impact Startup",
  "Gifting startup of the year",
  "Clean Tech / Green Startup of the Year",
];
...
const entrepreneurAwards = [
  ...
  "Entrepreneur of the Year ( Media & Entertainment )",
  "Social Entrepreneur of the Year",
  "Creative Entrepreneur of the Year",
  "Young Entrepreneur of the Year",
  "Restoration Entrepreneur of the Year",
...
const NominationForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!orgName.trim()) {
      showToast("Organization name required", true);
      return;
    }
    if (!promoter.trim()) {
      showToast("Promoter name required", true);
      return;
    }
    if (!ownership) {
      showToast("Please select ownership pattern", true);
      return;
    }
    if (!address.trim()) {
      showToast("Address required", true);
      return;
    }
    if (!mobile.trim()) {
      showToast("Mobile number required", true);
      return;
    }
    if (mobile.length < 8) {
    ...
    if (!state || state === "Select State") {
      showToast("Select state", true);
      return;
    }
    if (!city || city === "Select City") {
      showToast("Select city", true);
      return;
    }
    if (!email.trim() || !email.includes("@")) {
      showToast("Valid email required", true);
      return;
    }
    if (!agreeTerms) {
    ...
    let options: any = {
      ...
      amount: `${formDataObj.totalAmount}`, // Amount is in currency subunits.
      currency: "INR",
      ...
      prefill: {
        name: formDataObj.promoter, //your customer's name
        email: formDataObj.email,
        contact: formDataObj.mobile, //Provide the customer's phone number for better conversion rates
      },
      notes: {
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles["form-grid"]}>
            <div className={`${styles["input-group"]} ${styles["full-width"]}`}>
              <label>
                <i className="fas fa-building"></i> Name of the Organization
              </label>
              <input
                type="text"
                name="orgName"
          ...
          <div className={styles["fee-summary"]}>
            <div className={styles["fee-block"]}>
              <div className={styles["fee-item"]}>
                <strong>Registration Fees:</strong> INR 5500 (Exclusive GST 18%
                per category + handling charges)
              </div>
            </div>
